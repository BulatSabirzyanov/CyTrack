...
import com.example.cytrack.presentation.schedulefragment.date.DateDelegateItem
...
class GameDelegate(private val glide: RequestManager) : AdapterDelegate {
    ...
    class ViewHolder(private val binding: GameItemBinding) : RecyclerView.ViewHolder(binding.root) {
